...
const HeroSection = ({ userData }) => {
  ...
  const processCommand = (cmd) => {
    ...
    const responses = {
      ...
      '/projects': [
        'Recent Projects:',
        '• CMYK Analyzer - Determines the cmyk values of any image',
        '• ToDo List/Productivity Calendar - My personalized productivity machine',
        '',
    ...
    const funnyResponses = [
      ...
      "See, I'm not an AI, Hayden just built me for decoration... if you want smarter answers, pay for my OpenAI API key 💸",
